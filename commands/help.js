...
module.exports = {
  ...
  execute(message) {
    ...
    helpEmbed.addField(` **Links!** `, `**[Support Server](${support_server || "https://discord.gg/7Dx5j8TR8K"}) • [Invite](https://discord.com/oauth2/authorize?client_id=${message.client.user.id}&permissions=8&scope=bot)**`)
